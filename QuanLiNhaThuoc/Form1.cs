...
namespace QuanLiNhaThuoc
{
    public partial class Form1 : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void LoadKhachHangDaMua_Thang6()
        {
            string query = @"
                SELECT DISTINCT kh.MaKhachHang, kh.HoTenKH, kh.SDT, kh.DiaChi
                FROM HoaDon h
                JOIN KhachHang kh ON h.MaKhachHang = kh.MaKhachHang
                WHERE h.NgayBan BETWEEN '2024-06-01' AND '2024-06-30'
            ";
            DataTable dt = new DataTable();
            using (var db = new DatabaseHelper())
            {
            ...
            dgvKhachHangDaMua.DataSource = dt;
        }
